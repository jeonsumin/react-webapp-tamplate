        ...
        <>
            ...
            <div
                ...
                <div className="flex flex-col px-5 gap-3.5">
                    ...
                    {message && <span className="text-[16px] text-[var(--disabledBtn)]">{message}</span>}
                </div>
                {
                    !isConfirm &&
                    <div className="flex w-full gap-[10px] px-5 bottom-10 z-[100000] mt-5">
                        {isCancel && <button
                        ...
                        <button
                            className="rounded-full bg-blue-500 text-[20px] font-bold flex items-center justify-center min-h-[60px] w-full"
                            onClick={onConfirm}
                        >
                            확인
                        </button>
